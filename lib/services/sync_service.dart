...
// Matches sync_service.dart expectations
// ═══════════════════════════════════════════════════════════════
...
class WebSocketService {
  ...
  bool get isConnecting => _state == WsConnectionState.connecting || 
  ...
  void _scheduleReconnect() {
    ...
    final cappedDelay = delay > const Duration(seconds: 60) 
        ? const Duration(seconds: 60) 
        : delay;

    AppLogger.info('[WS] Reconnecting in ${cappedDelay.inSeconds}s (attempt ${_reconnectAttempts + 1})');
